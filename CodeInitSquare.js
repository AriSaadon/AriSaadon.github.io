function initializeSquares(){
	...
	[
		...
		new Square('squareB', 0.16, [
			{ progress: 0.0, x: 0.02, y: 0.3, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.16, x: 0.02, y: 0.3, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'detail' },
			{ progress: 0.33, x: 0.02, y: 0.2, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.83, x: 0.02, y: 0.2, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 1.0, x: 0.02, y: 0.3, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
		]),
		new Square('squareC', 0.33, [
			{ progress: 0.0, x: 0.02, y: 0.4, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.16, x: 0.02, y: 0.75, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.33, x: 0.02, y: 0.34, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'detail' },
			{ progress: 0.5, x: 0.02, y: 0.25, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.83, x: 0.02, y: 0.25, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 1.0, x: 0.02, y: 0.4, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
		]),
		new Square('squareD', 0.5, [
			{ progress: 0.0, x: 0.02, y: 0.5, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.16, x: 0.02, y: 0.825, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.33, x: 0.02, y: 0.825, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.5, x: 0.02, y: 0.33, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'detail' },
			{ progress: 0.66, x: 0.02, y: 0.3, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.83, x: 0.02, y: 0.3, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 1.0, x: 0.02, y: 0.5, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
		]),
		new Square('squareE', 0.66, [
			{ progress: 0.0, x: 0.02, y: 0.6, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.16, x: 0.02, y: 0.9, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.33, x: 0.02, y: 0.9, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.5, x: 0.02, y: 0.9, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 0.66, x: 0.02, y: 0.4, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'detail' },
			{ progress: 0.83, x: 0.02, y: 0.35, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
			{ progress: 1.0, x: 0.02, y: 0.6, width: 0.96, height: 0.05, border: 0, backgroundColor: color, visibleTag: 'summary' },
		]),
	];
	// [
	// 	new Square('squareA', -1, [
